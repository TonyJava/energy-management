...
//                $tdata['checked'] = true;
    ...
    public function addchild()
    {
        ...
        $this->getFloorstatus();
        $this->display();
                $regindata=$Model->query("select * from szny_region t
where t.rgn_atpstatus is null order by t.rgn_name asc");
         $this->assign('regindata', $regindata);
