            ...
            <div class="row row-lg">
                <div class="col-sm-12">
                     <div id="atpbiztoolbar">
                        <div>
                            <label class="control-label">查询范围：
...
<script>
    $(function () {
        $('#atpbiztable').bootstrapTable({
            url: '/index.php/Admin/Datacontrastanalyze/getData?ids=<?php echo ($ids); ?>&selectParam=<?php echo ($selectParam); ?>&start=<?php echo ($start); ?>&end=<?php echo ($end); ?>',         //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
...
//                    {checkbox: true},
                    ...
                    {field: 'time', title: '时间', align:'center', valign:'middle',sortable: false, width: 140},
...
//                $("#sys_dlg").load('/index.php/Admin/Datacontrastanalyze/edit?id=' + row['emp_atpid'], function() {
...
//        var ids = $("#ids").val();
        window.location.href='/index.php/Admin/Datacontrastanalyze/index?timerange=' + timerange + '&start='+start + '&end='+end+'&selectParam='+param +'&ids='+idstrings;
    });
</script>
<script>
    function choice(){
...
$(function () {
    $.ajax({
        type: "GET",
        url: "/index.php/Admin/Datacontrastanalyze/getData?ids=<?php echo ($ids); ?>&selectParam=<?php echo ($selectParam); ?>&start=<?php echo ($start); ?>&end=<?php echo ($end); ?>",
        dataType: "json",
