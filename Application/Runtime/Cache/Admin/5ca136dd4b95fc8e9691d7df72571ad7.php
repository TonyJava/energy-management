...
<div class="full_building">
    ...
    <img src="/Public/vendor/diy_component/yuanqu_page/images/2/2D-11F.png" width="60%" style="margin-top: 50px">
    ...
    <a class="energy_message cur" target="_self">
        ...
        <div class="alarmlist">
            <ul>
                ...
                <?php if(is_array($bjdata)): foreach($bjdata as $key=>$bj): ?><li class="border_bottom clearfix" onclick="window.location.href='/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidB0C345F6-B146-4BF5-9CCD-914747E4A966&rgn_atpidcurrent=<?php echo ($bj["rgn_atpid"]); ?>'">
...
<div class="total1">
    <header><p class="fl">2D#11层当月能耗&nbsp;&nbsp;&nbsp;&nbsp; <span style="font-size: 8px;"><?php echo '刷新时间:'.date('G:i:s').'(频率60秒)'; ?></span> </p><span class="fr zhankai"></span></header>
...
<script>
    ...
    function dodetail() {
        window.location.href='/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidB0C345F6-B146-4BF5-9CCD-914747E4A966&rgn_atpidcurrent=<?php echo ($bjdata[0]["rgn_atpid"]); ?>';
    }
