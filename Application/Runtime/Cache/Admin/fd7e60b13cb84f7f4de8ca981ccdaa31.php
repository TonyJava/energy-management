    ...
    <div class="ibox float-e-margins">
        <div class="ibox-content" style="padding: 10px 10px 10px 10px;margin-bottom: -15px;">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <i class="fa fa-hand-o-right"></i>&nbsp;当前位置:【<?php echo ($page); ?>】/【<?php echo ($page); ?>】/【综合信息】
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="main-right">
            <div class="ibox-content">
                <div class="row row-lg">
                    <div class="col-sm-12">
                        <iframe id="contentframe" src="/index.php/Admin/Userside/Usersidezhxx?us_atpid=<?php echo ($us_atpid); ?>"  frameborder="no" width="100%" scrolling="yes" height="1600px" ></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    var setting = {
        ...
        callback: {
            ...
            onClick: function (event, treeId, treeNode) {
                ...
                $('#contentframe').attr('src',"/index.php/Admin/Userside/Usersidezhxx?us_atpid=<?php echo ($us_atpid); ?>&rgn_atpid=" + RGN_ATPID);
            }
        }
    };
...
//        $('#treesearch').on("click",function(){alert('树搜索事件');});
    ...
    function backView()
    {
        window.location.href = '/index.php/Admin/Userside?bs=<?php echo ($_GET['bs']); ?>';
    }
