			...
			<div class="row row-lg">
				<div class="col-sm-12">
					...
					<iframe id = "message" frameborder=0 width=100% height="2000px" marginheight=0 marginwidth=0 scrolling=no
                            src='/index.php/Admin/RgGeneral/regionrootshow?regiontype=<?php echo ($_GET['regiontype']); ?>&snname=<?php echo ($_GET['snname']); ?>&regionlevel=<?php echo ($_GET['regionlevel']); ?>&tabindex=0&rgn_atpid=<?php echo ($_GET['rgn_atpid']); ?>'></iframe>
				</div>
		</div>
	</div>
	</div>
