                    ...
                    <nav class="page-tabs J_menuTabs">
                        <div class="page-tabs-content">
                           <!-- <a href='/index.php/Admin/Twicedatah/tableindex?rgn_atpid=<?php echo ($rgn_atpid); ?>' target="_self" class='J_menuTab'>时数据</a>-->
                            <a href='/index.php/Admin/Twicedatad/tableindex?rgn_atpid=<?php echo ($rgn_atpid); ?>' target="_self" class='J_menuTab active'>日数据</a>
                            <a href='/index.php/Admin/Twicedatam/tableindex?rgn_atpid=<?php echo ($rgn_atpid); ?>' target="_self"  class='J_menuTab'>月数据</a>
...
<script>
    $(function () {
        $('#atpbiztable').bootstrapTable({
            url: '/index.php/Admin/Twicedatad/getData?rgn_atpid=<?php echo ($rgn_atpid); ?>',         //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
...
//            cardView: true,                    //是否显示详细视图
          //  detailView: true,                   //是否显示父子表
            ...
            onDblClickRow: function (row) {
              /*  $("#sys_dlg").load('/index.php/Admin/Twicedatad/edit?id=' + row['atpid'], function() {
...
//                console.log(name+order);
    ...
    $('#sys_search').on('click',function() {
       ...
       window.location.href='/index.php/Admin/Twicedatad/tableindex?endtime='+endtime+'&starttime='+starttime+'&rgn_atpid='+regionid;
    ...
    $("#sys_exp").on('click',function(){
        ...
        $url='/index.php/Admin/Twicedatad/exp?endtime='+endtime+'&starttime='+starttime+'&rgn_atpid='+regionid;
        window.open($url);
    })
    $('#sys_edit').on('click',function() {
        window.location.href = '/index.php/Admin/Twicedatamodify?rgn_atpid=<?php echo ($rgn_atpid); ?>';
    });
