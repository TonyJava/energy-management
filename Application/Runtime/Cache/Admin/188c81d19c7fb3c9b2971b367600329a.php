            ...
            <div class="content-tabs">
                ...
                <nav class="page-tabs J_menuTabs">
                   <div class="page-tabs-content">
                        ...
                        <a target="_self" href="/index.php/Admin/Userside/Usersidetbhb?rgn_atpid=<?php echo ($rgn_atpid); ?>&us_atpid=<?php echo ($us_atpid); ?>"  class="onetab selected">同比环比</a>
                    </div>
                </nav>
...
<script>
    ...
    $(function () {
        $('#atpbiztable').bootstrapTable({
            url: '/index.php/Admin/Userside/getDatatbhb?ids=<?php echo ($ids); ?>&us_atpid=<?php echo ($us_atpid); ?>&selectParam=<?php echo ($selectParam); ?>&start=<?php echo ($start); ?>&end=<?php echo ($end); ?>',         //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
...
//                console.log(name+order);
    ...
    $('#sys_index_search').on('click', function () {
        ...
        window.location.href='/index.php/Admin/Userside/Usersidetbhb?start='+start + '&end='+end+'&rgn_atpid='+ rgn_atpid+'&us_atpid='+us_atpid+'&param='+param;
    });
</script>
...
<script>
    $(function () {
        $.ajax({
            type: "GET",
            url: "/index.php/Admin/Userside/getDatatbhb?ids=<?php echo ($ids); ?>&us_atpid=<?php echo ($us_atpid); ?>&selectParam=<?php echo ($selectParam); ?>&start=<?php echo ($start); ?>&end=<?php echo ($end); ?>",
            dataType: "json",
