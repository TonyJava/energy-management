                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">
                                        <span style="color: #CD0200;text-align: center">*</span>姓名：
                                    </label>
                                    <div class="col-sm-4">
                                        <input name="usr_usersideid" type="hidden"  value="<?php echo ($userside[0]["us_atpid"]); ?>" class="form-control">
                                        <input type="text"  value="<?php echo ($userside[0]["us_name"]); ?>" class="form-control" readonly>
                                        <p class="help-block" id="role_name_p" style="color: #CD0200;display:none">必填项！</p>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-sm-2 control-label">所有表：</label>
                                    <div class="col-sm-10">
