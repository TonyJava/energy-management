...
<head>
    ...
    <style>
        ...
        .alarmdian1_current {  left: 41%;  top: 16%;  position: absolute;  }
        .alarmdev1_current {  left: 50%;  top: 36%;  position: absolute;  }
        .alarmdev2_current {  left: 55%;  top: 46%;  position: absolute;  }
        .alarmdev3_current {  left: 57%;  top: 46%;  position: absolute;  }
        .alarmdev4_current {  left: 60%;  top: 30%;  position: absolute;  }
        .alarmdev5_current {  left: 62%;  top: 30%;  position: absolute;  }
        .alarmdev6_current {  left: 29%;  top: 14%;  position: absolute;  }
        .alarmdev7_current {  left: 30%;  top: 10%;  position: absolute;  }
        .alarmdev8_current {  left: 44%;  top: 7%;  position: absolute;  }
        .alarmdev9_current {  left: 42%;  top: 7%;  position: absolute;  }
        .alarmdev10_current {  left: 47%;  top: 7%;  position: absolute;  }
        .alarmdev11_current {  left: 47%;  top: 3%;  position: absolute;  }
        .alarmdev12_current {  left: 53%;  top: 38%;  position: absolute;  }
        .alarmdev13_current {  left: 54%;  top: 41%;  position: absolute;  }

        .alarmdian1 {  left: 41%;  top: 23%;  position: absolute;  }
        .alarmdev1 {  left: 50%;  top: 43%;  position: absolute;  }
        .alarmdev2 {  left: 55%;  top: 53%;  position: absolute;  }
        .alarmdev3 {  left: 57%;  top: 53%;  position: absolute;  }
        .alarmdev4 {  left: 60%;  top: 37%;  position: absolute;  }
        .alarmdev5 {  left: 62%;  top: 37%;  position: absolute;  }
        .alarmdev6 {  left: 29%;  top: 21%;  position: absolute;  }
        .alarmdev7 {  left: 30%;  top: 17%;  position: absolute;  }
        .alarmdev8 {  left: 44%;  top: 14%;  position: absolute;  }
        .alarmdev9 {  left: 42%;  top: 14%;  position: absolute;  }
        .alarmdev10 {  left: 47%;  top: 14%;  position: absolute;  }
        .alarmdev11 {  left: 47%;  top: 10%;  position: absolute;  }
        .alarmdev12 {  left: 53%;  top: 45%;  position: absolute;  }
        .alarmdev13 {  left: 54%;  top: 48%;  position: absolute;  }
    </style>
</head>
<body>
...
<div class="full_building">
    ...
    <img src="/Public/vendor/diy_component/yuanqu_page/images/2/2D-1F.png" width="60%" style="margin-top: 50px">
    ...
    <a class="energy_message cur" target="_self">
        ...
        <div class="alarmlist">
            <ul>
                ...
                <?php if(is_array($bjdata)): foreach($bjdata as $key=>$bj): ?><li class="border_bottom clearfix" onclick="window.location.href='/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidD471BC27-85B0-4E38-A408-B9AFE6DB267C&rgn_atpidcurrent=<?php echo ($bj["rgn_atpid"]); ?>'">
...
<div class="total1">
    <header><p class="fl">2D#1层当月能耗&nbsp;&nbsp;&nbsp;&nbsp; <span style="font-size: 8px;"><?php echo '刷新时间:'.date('G:i:s').'(频率60秒)'; ?></span> </p><span class="fr zhankai"></span></header>
...
<script>
    ...
    function dodetail() {
        window.location.href='/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidD471BC27-85B0-4E38-A408-B9AFE6DB267C&rgn_atpidcurrent=<?php echo ($bjdata[0]["rgn_atpid"]); ?>';
    }
