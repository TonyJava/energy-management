...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox float-e-margins">
        <div class="ibox-content" style="padding: 10px 10px 10px 10px;margin-bottom: -15px;">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <i class="fa fa-hand-o-right"></i>&nbsp;当前位置:【<?php echo ($_GET['title']); ?>】
                </div>
            </div>
        </div>
    </div>
    <div class="ibox float-e-margins">
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <iframe id="contentframe" src="/index.php/Admin/<?php echo ($_GET['controller']); ?>?regiontype=rg&tabshow=false"  frameborder="no" width="100%" scrolling="yes" height="1400px" ></iframe>
                </div>
            </div>
        </div>
    </div>
