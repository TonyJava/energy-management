...
<script>
	...
	$(function () {
        $('#atpbiztable').bootstrapTable({
            url: '/index.php/Admin/RgRepairDist/getData?regiontype=<?php echo ($_GET['regiontype']); ?>&snname=<?php echo ($_GET['snname']); ?>&regionlevel=<?php echo ($_GET['regionlevel']); ?>&tabindex=<?php echo ($_GET['tabindex']); ?>&rgn_atpid=<?php echo ($_GET['rgn_atpid']); ?>',         //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
...
//                console.log(name+order);
    ...
    function detail(a){
        window.parent.ATP_BOX_OPEN('/index.php/Admin/RgRepairDist/info?id=' + a, function () {
        });
    }

    function orders(a){
         window.parent.ATP_BOX_OPEN('/index.php/Admin/RgRepairDist/orders?id=' + a,orderssubmitpassdata);
    }

    function changerooter(a){
        // alert(a);
         window.parent.ATP_BOX_OPEN('/index.php/Admin/RgRepairDist/repairpeople?id='+a, repairpeoplesubmitdata);
    }
    ...
    function orderssubmitpassdata() {
        if (window.parent.ATP_BOX_VALIDATE()) {
            ...
            $.ajax({
                url: '/index.php/Admin/RgRepairDist/orderssubmitpassdata',
                type: 'POST',
    ...
    function repairpeoplesubmitdata()
    {
            ...
            $.ajax({
            url: '/index.php/Admin/RgRepairDist/repairpeoplesubmitdata',
            type: 'POST',
