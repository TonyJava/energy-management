                ...
                <div class="col-sm-12">
                    <div id="atpbiztoolbar">
                        <div>
                            ...
                            <!--<button class="btn btn-success " type="button" id="sys_index_search2"><i class="fa fa-search"></i>&nbsp;测试</button>-->
                        </div>
                    </div>
...
<script>
    $(function () {
        $('#atpbiztable').bootstrapTable({
            url: '/index.php/Admin/Datacontrastenergy/getData?ids=<?php echo ($ids); ?>&selectParam=<?php echo ($selectParam); ?>&start=<?php echo ($start); ?>&end=<?php echo ($end); ?>',         //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
...
//                $("#sys_dlg").load('/index.php/Admin/Datacontrastenergy/edit?id=' + row['emp_atpid'], function() {
...
//                console.log(name+order);
    ...
    $('#sys_index_search').on('click', function () {
        ...
        window.location.href='/index.php/Admin/Datacontrastenergy/index?timerange=' + timerange + '&start='+start + '&end='+end+'&selectParam='+param +'&ids='+idstrings;
    });

    $('#sys_index_search2').on('click', function () {
        var selectedtree = window.parent.ATP_SELECTED_TREE_ELEMENT();
        console.log(selectedtree);
//        console.log( $('#treeDemo', parent.document))
    });
