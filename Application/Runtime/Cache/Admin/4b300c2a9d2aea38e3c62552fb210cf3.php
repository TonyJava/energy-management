...
<head>
	<meta charset="UTF-8">
	<title>园区首页</title>
	<link rel="stylesheet" href="/Public/vendor/diy_component/yuanqu_page/css/yuanqu.css">
</head>
<body>
	<input type="hidden" value="<?php echo ($yearcon1["ydl"]); ?>" id="ydl1">

	<div class="full_building">
		<img src="/Public/vendor/diy_component/yuanqu_page/images/yuanqu.jpg" width="100%">
		<!--1#楼-->
		<a href="/index.php/Admin/Parkoverview/F1_ceng1F" class="point7 onehouse"></a>
		<div class="unusual7 unusual">
			<p>1#楼</p>
			<img src="/Public/vendor/diy_component/yuanqu_page/images/unusual.png">
		</div>
		<!--2#楼-->
		<a href="/index.php/Admin/Parkoverview/F2a_ceng1F" class="point3 onehouse"></a>
		<div class="unusual3 unusual">
			<p>2#A座</p>
			<img src="/Public/vendor/diy_component/yuanqu_page/images/unusual.png">
		</div>
		<a href="/index.php/Admin/Parkoverview/F2b_ceng1F" class="point2 onehouse"></a>
		<div class="unusual2 unusual">
			<p>2#B座</p>
			<img src="/Public/vendor/diy_component/yuanqu_page/images/unusual.png">
		</div>
		<a href="/index.php/Admin/Parkoverview/F2c_ceng1F" class="point4 onehouse"></a>
		<div class="unusual4 unusual">
			<p>2#C座</p>
			<img src="/Public/vendor/diy_component/yuanqu_page/images/unusual.png">
		</div>
		<a href="/index.php/Admin/Parkoverview/F2d_ceng1F" class="point1 onehouse"></a>
		<div class="unusual1 unusual">
			<p>2#D座</p>
			<img src="/Public/vendor/diy_component/yuanqu_page/images/unusual.png">
		</div>
		<a href="/index.php/Admin/Parkoverview/F2e_ceng1F" class="point6 onehouse"></a>
		<div class="unusual6 unusual">
			<p>2#E座</p>
			<img src="/Public/vendor/diy_component/yuanqu_page/images/unusual.png">
		</div>
		<a href="/index.php/Admin/Parkoverview/F2f_ceng1F" class="point5 onehouse"></a>
		<div class="unusual5 unusual">
			<p>2#F座</p>
			<img src="/Public/vendor/diy_component/yuanqu_page/images/unusual.png">
		</div>
		<!--3#楼-->
		<a href="/index.php/Admin/Parkoverview/F3_ceng1F" class="point8 onehouse"></a>
		...
		<div class="unusual9 unusual">
			<p>4#楼</p>
			<img src="/Public/vendor/diy_component/yuanqu_page/images/unusual.png">
			<!--<img src="/Public/vendor/diy_component/yuanqu_page/images/usual.png">-->
		</div>
		...
		<div class="/Public/vendor/diy_component/yuanqu_page/unusual15 unusual">
			<p>10#楼</p>
			<img src="/Public/vendor/diy_component/yuanqu_page/images/unusual.png">
		</div>
	...
	<div class="list-right" style="width: 360px;">
		...
		<div class="energy_message7 energy_message">
				...
				<?php if($alarmcount_bj1 != 0): ?><header style="background: #fc9900;cursor: pointer;"><p class="fl">1#楼（报警总数：<?php echo ($alarmcount_bj1); ?>条）</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidBFE08660-A606-4CD1-BDE0-3720CD50CED4">更多</a></span></header>
					<?php else: ?>
					<header style="cursor: pointer;"><p class="fl">1#楼</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidBFE08660-A606-4CD1-BDE0-3720CD50CED4">更多</a></span></header><?php endif; ?>
			...
			<div class="alarmlist border_bottom">
				<ul class="num1">
						...
						<?php if(is_array($bj1)): foreach($bj1 as $key=>$bj1): ?><a href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidBFE08660-A606-4CD1-BDE0-3720CD50CED4&rgn_atpidcurrent=<?php echo ($bj1["rgn_atpid"]); ?>">
		...
		<div class="energy_message3 energy_message">
				...
				<?php if($alarmcount_bj2a != 0): ?><header style="background: #fc9900;cursor: pointer;"><p class="fl">2#A座（报警总数：<?php echo ($alarmcount_bj2a); ?>条）</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid077698E9-2942-430A-81E1-E54A98A3383C">更多</a></span></header>
					<?php else: ?>
					<header style="cursor: pointer;"><p class="fl">2#A座</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid077698E9-2942-430A-81E1-E54A98A3383C">更多</a></span></header><?php endif; ?>


			<div class="alarmlist border_bottom">
				<ul class="num2a">

						<?php if(is_array($bj2a)): foreach($bj2a as $key=>$bj2a): ?><a href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid077698E9-2942-430A-81E1-E54A98A3383C&rgn_atpidcurrent=<?php echo ($bj1["rgn_atpid"]); ?>">
								<li class="border_bottom clearfix">
		...
		<div class="energy_message2 energy_message">
				...
				<?php if($alarmcount_bj2b != 0): ?><header style="background: #fc9900;cursor: pointer;"><p class="fl">2#B座（报警总数：<?php echo ($alarmcount_bj2b); ?>条）</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid5BAF01C0-E54E-4F2D-8419-09EA0507F4F2">更多</a></span></header>
					<?php else: ?>
					<header style="cursor: pointer;"><p class="fl">2#B座</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid5BAF01C0-E54E-4F2D-8419-09EA0507F4F2">更多</a></span></header><?php endif; ?>


			<div class="alarmlist border_bottom">
				<ul class="num2b">

						<?php if(is_array($bj2b)): foreach($bj2b as $key=>$bj2b): ?><a href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid5BAF01C0-E54E-4F2D-8419-09EA0507F4F2&rgn_atpidcurrent=<?php echo ($bj1["rgn_atpid"]); ?>">
								<li class="border_bottom clearfix">
		...
		<div class="energy_message4 energy_message">
				...
				<?php if($alarmcount_bj2c != 0): ?><header style="background: #fc9900;cursor: pointer;"><p class="fl">2#C座（报警总数：<?php echo ($alarmcount_bj2c); ?>条）</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid3BD09081-28C0-4ECD-BC25-0EB0DDF949B2">更多</a></span></header>
					<?php else: ?>
					<header style="cursor: pointer;"><p class="fl">2#C座</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid3BD09081-28C0-4ECD-BC25-0EB0DDF949B2">更多</a></span></header><?php endif; ?>

			<div class="alarmlist border_bottom">
				<ul class="num2c">

						<?php if(is_array($bj2c)): foreach($bj2c as $key=>$bj2c): ?><a href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid3BD09081-28C0-4ECD-BC25-0EB0DDF949B2&rgn_atpidcurrent=<?php echo ($bj1["rgn_atpid"]); ?>">
								<li class="border_bottom clearfix">
		...
		<div class="energy_message1 energy_message">
				...
				<?php if($alarmcount_bj2d != 0): ?><header style="background: #fc9900;cursor: pointer;"><p class="fl">2#D座（报警总数：<?php echo ($alarmcount_bj2d); ?>条）</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidF7E28F9A-E04C-4030-86E5-73A84A0B6CAD">更多</a></span></header>
					<?php else: ?>
					<header style="cursor: pointer;"><p class="fl">2#D座</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidF7E28F9A-E04C-4030-86E5-73A84A0B6CAD">更多</a></span></header><?php endif; ?>


			<div class="alarmlist border_bottom">
				<ul class="num2d">

						<?php if(is_array($bj2d)): foreach($bj2d as $key=>$bj2d): ?><a href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidF7E28F9A-E04C-4030-86E5-73A84A0B6CAD&rgn_atpidcurrent=<?php echo ($bj1["rgn_atpid"]); ?>">
								<li class="border_bottom clearfix">
		...
		<div class="energy_message6 energy_message">
				...
				<?php if($alarmcount_bj2e != 0): ?><header style="background: #fc9900;cursor: pointer;"><p class="fl">2#E座（报警总数：<?php echo ($alarmcount_bj2e); ?>条）</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid39E40DE8-E7B3-40D8-B8A8-E5C69AF1EBF5">更多</a></span></header>
					<?php else: ?>
					<header style="cursor: pointer;"><p class="fl">2#E座</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid39E40DE8-E7B3-40D8-B8A8-E5C69AF1EBF5">更多</a></span></header><?php endif; ?>


			<div class="alarmlist border_bottom">
				<ul class="num2e">

						<?php if(is_array($bj2e)): foreach($bj2e as $key=>$bj2e): ?><a href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid39E40DE8-E7B3-40D8-B8A8-E5C69AF1EBF5&rgn_atpidcurrent=<?php echo ($bj1["rgn_atpid"]); ?>">
								<li class="border_bottom clearfix">
		...
		<div class="energy_message5 energy_message">
				...
				<?php if($alarmcount_bj2f != 0): ?><header style="background: #fc9900;cursor: pointer;"><p class="fl">2#F座（报警总数：<?php echo ($alarmcount_bj2f); ?>条）</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid75D5A56E-A723-4E16-AAF9-97E86195E0AF">更多</a></span></header>
					<?php else: ?>
					<header style="cursor: pointer;"><p class="fl">2#F座</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid75D5A56E-A723-4E16-AAF9-97E86195E0AF">更多</a></span></header><?php endif; ?>


			<div class="alarmlist border_bottom">
				<ul class="num2f">

						<?php if(is_array($bj2f)): foreach($bj2f as $key=>$bj2f): ?><a href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid75D5A56E-A723-4E16-AAF9-97E86195E0AF&rgn_atpidcurrent=<?php echo ($bj1["rgn_atpid"]); ?>">
								<li class="border_bottom clearfix">
		...
		<div class="energy_message8 energy_message">
				...
				<?php if($alarmcount_bj3 != 0): ?><header style="background: #fc9900;cursor: pointer;"><p class="fl">3#楼（报警总数：<?php echo ($alarmcount_bj3); ?>条）</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidF5B91891-FC25-4448-84B9-0D7A544EFE6C">更多</a></span></header>
					<?php else: ?>
					<header style="cursor: pointer;"><p class="fl">3#楼</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidF5B91891-FC25-4448-84B9-0D7A544EFE6C">更多</a></span></header><?php endif; ?>


			<div class="alarmlist border_bottom">
				<ul class="num3">

						<?php if(is_array($bj3)): foreach($bj3 as $key=>$bj3): ?><a href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidF5B91891-FC25-4448-84B9-0D7A544EFE6C&rgn_atpidcurrent=<?php echo ($bj1["rgn_atpid"]); ?>">
								<li class="border_bottom clearfix">
		...
		<div class="energy_message9 energy_message">
				...
				<?php if($alarmcount_bj4 != 0): ?><header style="background: #fc9900;cursor: pointer;"><p class="fl">4#楼（报警总数：<?php echo ($alarmcount_bj4); ?>条）</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid8E6723F6-09D3-4CFF-B3AD-812A7F784201">更多</a></span></header>
					<?php else: ?>
					<header style="cursor: pointer;"><p class="fl">4#楼</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid8E6723F6-09D3-4CFF-B3AD-812A7F784201">更多</a></span></header><?php endif; ?>


			<div class="alarmlist border_bottom">
				<ul class="num4">

						<?php if(is_array($bj4)): foreach($bj4 as $key=>$bj4): ?><a href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid8E6723F6-09D3-4CFF-B3AD-812A7F784201&rgn_atpidcurrent=<?php echo ($bj1["rgn_atpid"]); ?>">
								<li class="border_bottom clearfix">
		...
		<div class="energy_message10 energy_message">
				...
				<?php if($alarmcount_bj5 != 0): ?><header style="background: #fc9900;cursor: pointer;"><p class="fl">5#楼（报警总数：<?php echo ($alarmcount_bj5); ?>条）</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidDDE6FF51-B4DD-42C1-962A-ED42D5120E88">更多</a></span></header>
					<?php else: ?>
					<header style="cursor: pointer;"><p class="fl">5#楼</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidDDE6FF51-B4DD-42C1-962A-ED42D5120E88">更多</a></span></header><?php endif; ?>
			...
			<div class="alarmlist border_bottom">
				<ul class="num5">
						...
						<?php if(is_array($bj5)): foreach($bj5 as $key=>$bj5): ?><a href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidDDE6FF51-B4DD-42C1-962A-ED42D5120E88&rgn_atpidcurrent=<?php echo ($bj1["rgn_atpid"]); ?>">
								<li class="border_bottom clearfix">
		...
		<div class="energy_message11 energy_message">
				...
				<?php if($alarmcount_bj6 != 0): ?><header style="background: #fc9900;cursor: pointer;"><p class="fl">6#楼（报警总数：<?php echo ($alarmcount_bj6); ?>条）</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidFEAFFDFB-4628-46D2-B39B-46F1EC76EF07">更多</a></span></header>
					<?php else: ?>
					<header style="cursor: pointer;"><p class="fl">6#楼</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidFEAFFDFB-4628-46D2-B39B-46F1EC76EF07">更多</a></span></header><?php endif; ?>


			<div class="alarmlist border_bottom">
				<ul class="num6">

						<?php if(is_array($bj6)): foreach($bj6 as $key=>$bj6): ?><a href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidFEAFFDFB-4628-46D2-B39B-46F1EC76EF07&rgn_atpidcurrent=<?php echo ($bj1["rgn_atpid"]); ?>">
								<li class="border_bottom clearfix">
		...
		<div class="energy_message12 energy_message">
				...
				<?php if($alarmcount_bj7 != 0): ?><header style="background: #fc9900;cursor: pointer;"><p class="fl">7#楼（报警总数：<?php echo ($alarmcount_bj7); ?>条）</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidC65AC6F2-6962-470C-9367-FF87BA1CD5CC">更多</a></span></header>
					<?php else: ?>
					<header style="cursor: pointer;"><p class="fl">7#楼</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidC65AC6F2-6962-470C-9367-FF87BA1CD5CC">更多</a></span></header><?php endif; ?>


			<div class="alarmlist border_bottom">
				<ul class="num7">

						<?php if(is_array($bj7)): foreach($bj7 as $key=>$bj7): ?><a href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidC65AC6F2-6962-470C-9367-FF87BA1CD5CC&rgn_atpidcurrent=<?php echo ($bj1["rgn_atpid"]); ?>">
								<li class="border_bottom clearfix">
		...
		<div class="energy_message13 energy_message">
				...
				<?php if($alarmcount_bj8 != 0): ?><header style="background: #fc9900;cursor: pointer;"><p class="fl">8#楼（报警总数：<?php echo ($alarmcount_bj8); ?>条）</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidB44A77BC-907D-42AC-812D-3E401E40B6CA">更多</a></span></header>
					<?php else: ?>
					<header style="cursor: pointer;"><p class="fl">8#楼</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidB44A77BC-907D-42AC-812D-3E401E40B6CA">更多</a></span></header><?php endif; ?>


			<div class="alarmlist border_bottom">
				<ul class="num8">

						<?php if(is_array($bj8)): foreach($bj8 as $key=>$bj8): ?><a href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guidB44A77BC-907D-42AC-812D-3E401E40B6CA&rgn_atpidcurrent=<?php echo ($bj1["rgn_atpid"]); ?>">
								<li class="border_bottom clearfix">
		...
		<div class="energy_message14 energy_message">
				...
				<?php if($alarmcount_bj9 != 0): ?><header style="background: #fc9900;cursor: pointer;"><p class="fl">9#楼（报警总数：<?php echo ($alarmcount_bj9); ?>条）</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid0CCA3B48-E22B-4636-A0EC-1F0E81AE0F08">更多</a></span></header>
					<?php else: ?>
					<header style="cursor: pointer;"><p class="fl">9#楼</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid0CCA3B48-E22B-4636-A0EC-1F0E81AE0F08">更多</a></span></header><?php endif; ?>

			<div class="alarmlist border_bottom">
				<ul class="num9">

						<?php if(is_array($bj9)): foreach($bj9 as $key=>$bj9): ?><a href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid0CCA3B48-E22B-4636-A0EC-1F0E81AE0F08&rgn_atpidcurrent=<?php echo ($bj1["rgn_atpid"]); ?>">
								<li class="border_bottom clearfix">
		...
		<div class="energy_message15 energy_message">
				...
				<?php if($alarmcount_bj10 != 0): ?><header style="background: #fc9900;cursor: pointer;"><p class="fl">10#楼（报警总数：<?php echo ($alarmcount_bj10); ?>条）</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid3696CE0E-0616-4B32-8AB2-40AA8DB2E1D6">更多</a></span></header>
					<?php else: ?>
					<header style="cursor: pointer;"><p class="fl">10#楼</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid3696CE0E-0616-4B32-8AB2-40AA8DB2E1D6">更多</a></span></header><?php endif; ?>


			<div class="alarmlist border_bottom">
				<ul class="num10">

						<?php if(is_array($bj10)): foreach($bj10 as $key=>$bj10): ?><a href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid3696CE0E-0616-4B32-8AB2-40AA8DB2E1D6&rgn_atpidcurrent=<?php echo ($bj1["rgn_atpid"]); ?>">
								<li class="border_bottom clearfix">
		...
		<div class="energy_message16 energy_message">
				...
				<?php if($alarmcount_bj11 != 0): ?><header style="background: #fc9900;cursor: pointer;"><p class="fl">11#楼（报警总数：<?php echo ($alarmcount_bj11); ?>条）</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid1F1285F0-C495-46D7-969A-D3711B12EA28">更多</a></span></header>
					<?php else: ?>
					<header style="cursor: pointer;"><p class="fl">11#楼</p><span class="fr zhankai"><a style="color: white" href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid1F1285F0-C495-46D7-969A-D3711B12EA28">更多</a></span></header><?php endif; ?>


			<div class="alarmlist border_bottom">
				<ul class="num11">

						<?php if(is_array($bj11)): foreach($bj11 as $key=>$bj11): ?><a href="/index.php/Admin/Rg/indexparkoverviewshell?regionlevel=region&rgn_atpid=guid1F1285F0-C495-46D7-969A-D3711B12EA28&rgn_atpidcurrent=<?php echo ($bj11["rgn_atpid"]); ?>">
								<li class="border_bottom clearfix">
...
<script src="/Public/vendor/diy_component/yuanqu_page/js/jquery-1.7.2.js"></script>
...
setInterval(function(){
	// 数据对比
	$.ajax({
       url: '/index.php/Admin/ParkoverviewGataindex/ajax',
       type: 'POST',
       data: {},
       async:false,
		   ...
		   if (data) {
			   ...
			   if (newdata['newarr1'].length != 0) {
				   ...
				   newdata['newarr1'].forEach(function (value, index, array) {
					   tstr += "<a href='/index.php/Admin/Rg/indexparkoverviewshell?rgn_atpid=" + newdata['newarr1'][index].rgn_atpid + "'><li class='border_bottom clearfix'>" +
			   ...
			   if (newdata['newarr2a'].length != 0) {
				   ...
				   newdata['newarr2a'].forEach(function (value, index, array) {
					   tstr += "<a href='/index.php/Admin/Rg/indexparkoverviewshell?rgn_atpid=" + newdata['newarr2a'][index].rgn_atpid + "'><li class='border_bottom clearfix'>" +
			   ...
			   if (newdata['newarr2b'].length != 0) {
				   ...
				   newdata['newarr2b'].forEach(function (value, index, array) {
					   tstr += "<a href='/index.php/Admin/Rg/indexparkoverviewshell?rgn_atpid=" + newdata['newarr2b'][index].rgn_atpid + "'><li class='border_bottom clearfix'>" +
			   ...
			   if (newdata['newarr2c'].length != 0) {
				   ...
				   newdata['newarr2c'].forEach(function (value, index, array) {
					   tstr += "<a href='/index.php/Admin/Rg/indexparkoverviewshell?rgn_atpid=" + newdata['newarr2c'][index].rgn_atpid + "'><li class='border_bottom clearfix'>" +
			   ...
			   if (newdata['newarr2d'].length != 0) {
				   ...
				   newdata['newarr2d'].forEach(function (value, index, array) {
					   tstr += "<a href='/index.php/Admin/Rg/indexparkoverviewshell?rgn_atpid=" + newdata['newarr2d'][index].rgn_atpid + "'><li class='border_bottom clearfix'>" +
			   ...
			   if (newdata['newarr2e'].length != 0) {
				   ...
				   newdata['newarr2e'].forEach(function (value, index, array) {
					   tstr += "<a href='/index.php/Admin/Rg/indexparkoverviewshell?rgn_atpid=" + newdata['newarr2e'][index].rgn_atpid + "'><li class='border_bottom clearfix'>" +
			   ...
			   if (newdata['newarr2f'].length != 0) {
				   ...
				   newdata['newarr2f'].forEach(function (value, index, array) {
					   tstr += "<a href='/index.php/Admin/Rg/indexparkoverviewshell?rgn_atpid=" + newdata['newarr2f'][index].rgn_atpid + "'><li class='border_bottom clearfix'>" +
			   ...
			   if (newdata['newarr3'].length != 0) {
				   ...
				   newdata['newarr3'].forEach(function (value, index, array) {
					   tstr += "<a href='/index.php/Admin/Rg/indexparkoverviewshell?rgn_atpid=" + newdata['newarr3'][index].rgn_atpid + "'><li class='border_bottom clearfix'>" +
			   ...
			   if (newdata['newarr4'].length != 0) {
				   ...
				   newdata['newarr4'].forEach(function (value, index, array) {
					   tstr += "<a href='/index.php/Admin/Rg/indexparkoverviewshell?rgn_atpid=" + newdata['newarr4'][index].rgn_atpid + "'><li class='border_bottom clearfix'>" +
			   ...
			   if (newdata['newarr5'].length != 0) {
				   ...
				   newdata['newarr5'].forEach(function (value, index, array) {
					   tstr += "<a href='/index.php/Admin/Rg/indexparkoverviewshell?rgn_atpid=" + newdata['newarr5'][index].rgn_atpid + "'><li class='border_bottom clearfix'>" +
			   ...
			   if (newdata['newarr6'].length != 0) {
				   ...
				   newdata['newarr6'].forEach(function (value, index, array) {
					   tstr += "<a href='/index.php/Admin/Rg/indexparkoverviewshell?rgn_atpid=" + newdata['newarr6'][index].rgn_atpid + "'><li class='border_bottom clearfix'>" +
			   ...
			   if (newdata['newarr7'].length != 0) {
				   ...
				   newdata['newarr7'].forEach(function (value, index, array) {
					   tstr += "<a href='/index.php/Admin/Rg/indexparkoverviewshell?rgn_atpid=" + newdata['newarr7'][index].rgn_atpid + "'><li class='border_bottom clearfix'>" +
			   ...
			   if (newdata['newarr8'].length != 0) {
				   ...
				   newdata['newarr8'].forEach(function (value, index, array) {
					   tstr += "<a href='/index.php/Admin/Rg/indexparkoverviewshell?rgn_atpid=" + newdata['newarr8'][index].rgn_atpid + "'><li class='border_bottom clearfix'>" +
			   ...
			   if (newdata['newarr9'].length != 0) {
				   ...
				   newdata['newarr9'].forEach(function (value, index, array) {
					   tstr += "<a href='/index.php/Admin/Rg/indexparkoverviewshell?rgn_atpid=" + newdata['newarr9'][index].rgn_atpid + "'><li class='border_bottom clearfix'>" +
			   ...
			   if (newdata['newarr10'].length != 0) {
				   ...
				   newdata['newarr10'].forEach(function (value, index, array) {
					   tstr += "<a href='/index.php/Admin/Rg/indexparkoverviewshell?rgn_atpid=" + newdata['newarr10'][index].rgn_atpid + "'><li class='border_bottom clearfix'>" +
			   ...
			   if (newdata['newarr11'].length != 0) {
				   ...
				   newdata['newarr11'].forEach(function (value, index, array) {
					   tstr += "<a href='/index.php/Admin/Rg/indexparkoverviewshell?rgn_atpid=" + newdata['newarr11'][index].rgn_atpid + "'><li class='border_bottom clearfix'>" +
