    ...
    <div class="ibox float-e-margins">
        ...
        <div class="main-right">
            <div class="ibox-content">
                <div class="row row-lg">
                    <div class="col-sm-12">
                        <iframe id="contentframe" src="/index.php/Admin/Twicedatad/tableindex?rgn_atpid=<?php echo ($rgn_atpid); ?>"  frameborder="no" width="100%" scrolling="yes" height="700px" ></iframe>
                    </div>
                </div>
            </div>
        </div>
...
//                console.log(treeNode);
               // if ('设备点' == treeNode.type) {
                    ...
                    $('#contentframe').attr('src',"/index.php/Admin/Twicedatad/tableindex?rgn_atpid=" + RGN_ATPID);
