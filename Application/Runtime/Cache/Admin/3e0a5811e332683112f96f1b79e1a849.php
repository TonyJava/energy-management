...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="main-right">
        <div class="ibox-content">
            <div class="row row-lg">
                <div class="col-sm-12">
                    <iframe id="contentframe" src="/index.php/Admin/Datacontrastreport/index"  frameborder="no" width="100%" scrolling="yes" height="720px" ></iframe>
                </div>
            </div>
        </div>
    </div>
...
////                alert(ids);
////                console.log(ids);
//                $.post('/index.php/Admin/Datacontrast/getIds',{ids:ids.join(',')},function (data) {
//                    if ('' == data){
//                        $('#contentframe').attr('src',"/index.php/Admin/Datacontrastreport/index?ids=" + ids);
//                    }
//                })
//            }
        }
