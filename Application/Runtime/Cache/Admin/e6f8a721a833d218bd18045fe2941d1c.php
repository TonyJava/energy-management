...
<script>
    ...
    $(function () {
        ...
        $('#atpbiztable').bootstrapTable({
            url: '/index.php/Admin/Usersidenergy/getData?start=<?php echo ($start); ?>&end=<?php echo ($end); ?>&bs=<?php echo ($bs); ?>',         //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
...
//                $("#sys_dlg").load('/index.php/Admin/Usersidenergy/edit?id=' + row['us_atpid'], function() {
    ...
    $('#btn_configyear').on('click',function() {
        ...
        $('#sys_dlg_search_submit_year').on('click', function () {
            if ($.html5Validate.isAllpass($("#sys_dlg_search_year_form"))) {
                ...
                window.location.href='/index.php/Admin/Usersidenergy/index?start='+start + '&end='+end + '&bs=<?php echo ($bs); ?>';
            }
        });
    });
    //////////////////////////////////////////////////////////////////////////////////////////////////////
