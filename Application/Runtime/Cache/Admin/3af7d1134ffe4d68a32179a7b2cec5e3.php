    ...
    <div class="ibox float-e-margins">
        ...
        <div class="main-right">
            <div class="ibox-content">
                <div class="row row-lg">
                    <div class="col-sm-12">
                        <iframe id="contentframe" src="/index.php/Admin/Originaldata/tableindex"  frameborder="no" width="100%" scrolling="yes" height="700px" ></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    var setting = {
        ...
        callback: {
            ...
            onClick: function (event, treeId, treeNode) {
					...
					$('#contentframe').attr('src',"/index.php/Admin/Originaldata/tableindex?regionid=" + RGN_ATPID);
