...
<head>
    ...
    <link rel="stylesheet" href="/Public/vendor/diy_component/yuanqu_page/css/floor-new.css">
</head>
...
<div class="messagetop clearfix" style="margin-top: 20px;border:1px solid #ddd">
    ...
    <iframe id = "message" frameborder=0 width=100% height="330px" marginheight=0 marginwidth=0 scrolling=no
            src='/index.php/Admin/RgGeneral/func_regionenergychart?regiontype=<?php echo ($_GET['regiontype']); ?>&snname=<?php echo ($_GET['snname']); ?>&regionlevel=<?php echo ($_GET['regionlevel']); ?>&tabindex=<?php echo ($_GET['tabindex']); ?>&rgn_atpid=<?php echo ($_GET['rgn_atpid']); ?>'></iframe>
</div>
...
<div class="messagetop clearfix" style="margin-top: 20px;margin-right: 5px;padding-bottom:5px;border:1px solid #ddd;border-radius: 5px">
    <div class="yibiao">
        ...
        <div class="tablebox" >
            <iframe frameborder=0 width=100% style="min-height:350px"  marginheight=0 marginwidth=0 scrolling=no src='/index.php/Admin/RgGeneral/func_energycoast?regiontype=<?php echo ($_GET['regiontype']); ?>&snname=<?php echo ($_GET['snname']); ?>&regionlevel=<?php echo ($_GET['regionlevel']); ?>&tabindex=0&rgn_atpid=<?php echo ($_GET['rgn_atpid']); ?>'></iframe>
        </div>
    </div>
</div>
...
<div class="messagetop clearfix" style="margin-top: 20px;margin-right: 5px;padding-bottom:5px;border:1px solid #ddd;border-radius: 5px">
    <div class="yibiao">
        ...
        <div class="tablebox" >
            <iframe frameborder=0 width=100% style="min-height:350px" marginheight=0 marginwidth=0 scrolling=no src='/index.php/Admin/RgGeneral/func_alarminfo?regiontype=<?php echo ($_GET['regiontype']); ?>&snname=<?php echo ($_GET['snname']); ?>&regionlevel=<?php echo ($_GET['regionlevel']); ?>&tabindex=0&rgn_atpid=<?php echo ($_GET['rgn_atpid']); ?>'></iframe>
        </div>
    </div>
</div>
